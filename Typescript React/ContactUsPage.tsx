                        ...
                        <div className="FormContainer">
                            <div className="form-group" id="askForm">
                                <form>
                                    ...
                                    <strong><h5>Email<span style={{ color: "red" }}>*</span></h5></strong>
                                    <Input
                                        type="text"
                                        label=""
                                        name="email"
                                    ...
                                    />
                                    <strong><h5>First Name<span style={asterikStyle}>*</span></h5></strong>
                                    <Input
                                        type="text"
                                        label=""
                                        name="firstName"
                                    ...
                                    />
                                    <strong><h5>Last Name<span style={asterikStyle}>*</span></h5></strong>
                                    <Input
                                        type="text"
                                        label=""
                                        name="lastName"
                                    ...
                                    />
                                    <strong><h5>Subject<span style={asterikStyle}>*</span></h5></strong>
                                    <DropDownList
                                    ...
                                    <strong><h5>Please enter your thoughts, ideas or comments below<span style={asterikStyle}>*</span></h5></strong>
